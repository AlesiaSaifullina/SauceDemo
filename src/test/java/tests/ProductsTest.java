...
public class ProductsTest extends BaseTest {
    ...
    @Test(description = "Проверка страницы детализации продукта")
    ...
    @Test(description = "Проверка сортировки: Name (A to Z) ")
    ...
    @Test(description = "Проверка сортировки: Name (Z to A) ")
    ...
    @Test(description = "Проверка сортировки: Price (low to high) ")
    ...
    @Test(description = "Проверка сортировки: Price (high to low) ")
